...
class Analysis:
    def __init__(self, data):
        ...
        self.topSlices = 208  # default = 50 INCLUDE SILENCE
        # self.words      = data["words"]        # default = 901
        # self.words      = 1162        # default = 901
        self.words = 208  # default = 901
    ...
    def processChunk(self, dataDF):
        ...
        # import rhymes
        with open(rhymes_cohorts_dir + 'tlex_rhymes_cohorts.pickle', 'rb') as f:
...
if __name__ == "__main__":
    ...
    rhymes_cohorts_dir = '/Users/nikitasossounov/thesis/jsTRACE/JSTrace-repo/scripts/rhymes-cohorts/tlex/'
    # beg_time = time.time()
